...
export const PLAYER_SPRITE_SHEET: SpriteSheetDescriptor = {
    ...
    imageDescriptors: {
        ...
        L_IDLE_1: {offsetX: 77, offsetY: 0, width: 60, height: 60},
        L_IDLE_2: {offsetX: 137, offsetY: 0, width: 60, height: 60},
        L_IDLE_3: {offsetX: 197, offsetY: 0, width: 60, height: 60},
        L_IDLE_4: {offsetX: 257, offsetY: 0, width: 60, height: 60},
        L_WALK_0: {offsetX: 317, offsetY: 0, width: 61, height: 61},
        L_WALK_1: {offsetX: 378, offsetY: 0, width: 61, height: 61},
        L_WALK_2: {offsetX: 439, offsetY: 0, width: 61, height: 61},
        L_WALK_3: {offsetX: 500, offsetY: 0, width: 61, height: 61},
        L_WALK_4: {offsetX: 561, offsetY: 0, width: 61, height: 61},
        L_RUN_0: {offsetX: 622, offsetY: 0, width: 63, height: 63},
        L_RUN_1: {offsetX: 685, offsetY: 0, width: 63, height: 63},
        L_RUN_2: {offsetX: 748, offsetY: 0, width: 63, height: 63},
        L_RUN_3: {offsetX: 811, offsetY: 0, width: 63, height: 63},
        L_RUN_4: {offsetX: 874, offsetY: 0, width: 63, height: 63},
        L_JUMP_0: {offsetX: 937, offsetY: 0, width: 58, height: 58},
        L_JUMP_1: {offsetX: 995, offsetY: 0, width: 58, height: 58},
        L_JUMP_2: {offsetX: 1053, offsetY: 0, width: 58, height: 58},
        L_JUMP_3: {offsetX: 1111, offsetY: 0, width: 58, height: 58},
        L_JUMP_4: {offsetX: 1169, offsetY: 0, width: 58, height: 58},
        L_ATTACK_0: {offsetX: 1227, offsetY: 0, width: 65, height: 65},
        L_ATTACK_1: {offsetX: 1292, offsetY: 0, width: 65, height: 65},
        L_ATTACK_2: {offsetX: 1357, offsetY: 0, width: 65, height: 65},
        L_ATTACK_3: {offsetX: 1422, offsetY: 0, width: 65, height: 65},
        L_ATTACK_4: {offsetX: 4, offsetY: 74, width: 65, height: 65},
        L_HURT_0: {offsetX: 69, offsetY: 75, width: 70, height: 70},
        L_HURT_1: {offsetX: 139, offsetY: 75, width: 70, height: 70},
        L_HURT_2: {offsetX: 209, offsetY: 75, width: 70, height: 70},
        L_HURT_3: {offsetX: 279, offsetY: 75, width: 70, height: 70},
        L_HURT_4: {offsetX: 349, offsetY: 75, width: 70, height: 70},
        L_DIE_0: {offsetX: 419, offsetY: 86, width: 70, height: 70},
        L_DIE_1: {offsetX: 489, offsetY: 86, width: 70, height: 70},
        L_DIE_2: {offsetX: 559, offsetY: 86, width: 70, height: 70},
        L_DIE_3: {offsetX: 629, offsetY: 86, width: 70, height: 70},
        L_DIE_4: {offsetX: 699, offsetY: 86, width: 70, height: 70},
        R_IDLE_0: {offsetX: 769, offsetY: 74, width: 60, height: 60},
        R_IDLE_1: {offsetX: 829, offsetY: 74, width: 60, height: 60},
        R_IDLE_2: {offsetX: 889, offsetY: 74, width: 60, height: 60},
        R_IDLE_3: {offsetX: 949, offsetY: 74, width: 60, height: 60},
        R_IDLE_4: {offsetX: 1009, offsetY: 74, width: 60, height: 60},
        R_WALK_0: {offsetX: 1069, offsetY: 74, width: 61, height: 61},
        R_WALK_1: {offsetX: 1130, offsetY: 74, width: 61, height: 61},
        R_WALK_2: {offsetX: 1191, offsetY: 74, width: 61, height: 61},
        R_WALK_3: {offsetX: 1252, offsetY: 74, width: 61, height: 61},
        R_WALK_4: {offsetX: 1313, offsetY: 74, width: 61, height: 61},
        R_RUN_0: {offsetX: 1374, offsetY: 74, width: 63, height: 63},
        R_RUN_1: {offsetX: 1437, offsetY: 74, width: 63, height: 63},
        R_RUN_2: {offsetX: 0, offsetY: 148, width: 63, height: 63},
        R_RUN_3: {offsetX: 63, offsetY: 148, width: 63, height: 63},
        R_RUN_4: {offsetX: 126, offsetY: 148, width: 63, height: 63},
        R_JUMP_0: {offsetX: 189, offsetY: 148, width: 58, height: 58},
        R_JUMP_1: {offsetX: 247, offsetY: 148, width: 58, height: 58},
        R_JUMP_2: {offsetX: 305, offsetY: 148, width: 58, height: 58},
        R_JUMP_3: {offsetX: 363, offsetY: 148, width: 58, height: 58},
        R_JUMP_4: {offsetX: 421, offsetY: 148, width: 58, height: 58},
        R_ATTACK_0: {offsetX: 479, offsetY: 148, width: 65, height: 65},
        R_ATTACK_1: {offsetX: 544, offsetY: 148, width: 65, height: 65},
        R_ATTACK_2: {offsetX: 609, offsetY: 148, width: 65, height: 65},
        R_ATTACK_3: {offsetX: 674, offsetY: 148, width: 65, height: 65},
        R_ATTACK_4: {offsetX: 739, offsetY: 148, width: 65, height: 65},
        R_HURT_0: {offsetX: 804, offsetY: 149, width: 70, height: 70},
        R_HURT_1: {offsetX: 874, offsetY: 149, width: 70, height: 70},
        R_HURT_2: {offsetX: 944, offsetY: 149, width: 70, height: 70},
        R_HURT_3: {offsetX: 1014, offsetY: 149, width: 70, height: 70},
        R_HURT_4: {offsetX: 1084, offsetY: 149, width: 70, height: 70},
        R_DIE_0: {offsetX: 1154, offsetY: 160, width: 70, height: 70},
        R_DIE_1: {offsetX: 1224, offsetY: 160, width: 70, height: 70},
        R_DIE_2: {offsetX: 1294, offsetY: 160, width: 70, height: 70},
        R_DIE_3: {offsetX: 1364, offsetY: 160, width: 70, height: 70},
        R_DIE_4: {offsetX: 1434, offsetY: 160, width: 70, height: 70}
    }
};
